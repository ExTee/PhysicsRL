...
public class RigidBody {
    ...
    Vector2d previous_force = new Vector2d();
    ...
    public Vector2d getLocalPoint(Vector2d  worldPoint)
    {
    	Vector2d tmp = new Vector2d(0,0);
    	this.transformW2B.transform(worldPoint, tmp);
    	return tmp;
    }
    
    public Vector2d getWorldPoint(Vector2d  localPoint)
    {
    	Vector2d tmp = new Vector2d(0,0);
    	this.transformB2W.transform(localPoint, tmp);
    	return tmp;
    }
    ...
    public RigidBody( ArrayList<Block> blocks, ArrayList<Block> boundaryBlocks ) {
        ...
        //System.out.println(" Size of boundary blocks: " + this.boundaryBlocks.size());
        //System.out.println(" Size of total blocks: " + this.blocks.size());
        // compute the mass and center of mass position        
        for ( Block b : blocks ) {
        	//System.out.println("X: " + b.i + "  Y: " + b.j);
	...
	public void displayForces(GLAutoDrawable drawable) {

	      final GL2 gl = drawable.getGL().getGL2();
	      gl.glLineWidth( 1 );
	      //drawing the base
	      gl.glBegin (GL2.GL_LINES);
	      gl.glColor3f(1.000f, 0.000f, 1.000f);

	      gl.glVertex2d(this.x.x, this.x.y);
	      
	      //Scaled down the previous force to be more reasonable
	      this.previous_force.scale(0.05);
	      Vector2d tmp = new Vector2d(this.previous_force);
	      tmp.add(this.x);
